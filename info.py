...
API_HASH = int(environ['04a4924d21afcd9d27495f664a668f39'])
BOT_TOKEN = int(environ['6148749801:AAHvMG1754LdPRuPm4nPF14MvAyMqV2dnKY'])
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1093884939', '1096700039').split()]
...
# Custom Chats
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001821451122'))
...
# FSUB
auth_channel = environ.get('-1001741571047')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("-1001741571047", True)
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else False
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DATABASE_URI)
group_sub = environ.get('-1001773324199')
...
LOG_CHANNEL = int(environ.get('-1001686547778', 0))
FILE_CHANNEL = int(environ.get('-1001821451122', 0))
